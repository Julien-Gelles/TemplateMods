...
public class ModBlocks {
    ...
    public static final Block DEEPSLATE_RAW_RUBY_BLOCK = registerBlock("deepslate_raw_ruby_block", new Block(FabricBlockSettings.copyOf(Blocks.DEEPSLATE_IRON_ORE)));
